...
\section{Activités Annexes}
  ...
  \resumeSubheading
    ...
    \resumeItemListStart
        ...
        \resumeItem{Sensibilisé les élèves à l’intelligence artificielle, en exposant l’état actuel du domaine et ses applications concrètes.}
...
\resumeProjectHeading
    ...
    {Académique}
    \resumeItemListStart
        \resumeItem{Description du projet}
        \resumeItem{Rôle du projet}
    \resumeItemListEnd
    \vspace{1mm}


\resumeProjectHeading
    {Autopilot Driver Genetic Algorithm}{2023 -- 2024}
    {Académique}
    \resumeItemListStart
        \resumeItem{Description du projet}
        \resumeItem{Rôle du projet}
...
\href{https://www.linkedin.com/in/dion-osmani-60478720b/}{linkedin.com/in/dion-osmani} $|$
